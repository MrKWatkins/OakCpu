...
public sealed class M6502StepEmulatorTests
{
    static M6502StepEmulatorTests()
    {
...
#pragma warning restore CA1065
    ...
    public void ExecuteInstruction_Nop()
    {
        ...
        m6502.Cycles.Should().SequenceEqual(new MrKWatkins.EmulatorTestSuites.M6502.Cycle(EmulatorTestSuites.M6502.CycleType.Read, 0, 0x0000, 0xEA), new MrKWatkins.EmulatorTestSuites.M6502.Cycle(EmulatorTestSuites.M6502.CycleType.Read, 1, 0x0001, 0x99));
    }
    ...
    public void ExecuteInstruction_Lda_Immediate()
    {
        ...
        m6502.Cycles.Should().SequenceEqual(new MrKWatkins.EmulatorTestSuites.M6502.Cycle(EmulatorTestSuites.M6502.CycleType.Read, 0, 0x0000, 0xA9), new MrKWatkins.EmulatorTestSuites.M6502.Cycle(EmulatorTestSuites.M6502.CycleType.Read, 1, 0x0001, 0xCC));
    }
}
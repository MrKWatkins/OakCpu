...
public class Z80StepEmulatorTestHarness(Z80StepEmulator emulator) : Z80SteppableTestHarness
{
    private readonly byte[] memory = new byte[65536];

    public Z80StepEmulatorTestHarness()
    ...
    // TODO: Remove.
    public Z80StepEmulator Emulator => emulator;

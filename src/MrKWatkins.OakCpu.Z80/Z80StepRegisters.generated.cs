...
/// <inheritdoc/>
public sealed class Z80StepRegisters : Z80Registers
{
    private readonly Z80StepEmulator emulator;

    internal Z80StepRegisters(Z80StepEmulator emulator) : base(new Z80StepShadowRegisters(emulator))
    {
    ...
    /// <inheritdoc/>
    public override Z80StepShadowRegisters Shadow => (Z80StepShadowRegisters)base.Shadow;
}

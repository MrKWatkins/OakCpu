...
public sealed class ContendedZ80EmulatorTests
{
    [Test]
    public void Step_PreservesPendingActionAcrossDelay()
    {
        ...
        var contended = new ContendedZ80Emulator(z80, tStatesInCurrentFrame: 14335);
    ...
    {
        var contended = new ContendedZ80Emulator(new Z80Emulator(), tStatesInCurrentFrame: 1234);
    ...
    public void Step_UsesExternalInterruptState()
    {
        ...
        var z80 = new Z80Emulator();
        var contended = new ContendedZ80Emulator(z80);
        ...
        PerformActionRequired(memory, z80, contended.Step());
        z80.CurrentStep.Should().Equal(ContendedZ80Emulator.IM1Start);
    }

    private static void PerformActionRequired(byte[] memory, Z80Emulator emulator, ActionRequired actionRequired)
    {
